...
# Each entry in the dataset corresponds to a patient record, containing various symptom indicators and diagnosis labels.
...
# This binning simplifies age-based comparisons in visualizations such as heatmaps or parallel coordinate charts.
def age_group(age):
    if age < 40:
        return "30-39"
    elif age < 50:
